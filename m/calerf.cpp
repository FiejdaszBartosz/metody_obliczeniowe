...
const long double aintl_(const long double x) { // This function has been added by L. K. Bieniasz
...
long double calerf::CALERF_L(const long double arg, const int jint) {
//-----------------------------------------------------------------
//
//  This packet evaluates erf(x), erfc(x), and exp(x*x)*erfc(x)
//  for a real argument x.  It contains four long double functions:
//  ERF_L(), ERFC_L(), and erexl(), and CALERF_L().
//
...
long double calerf::ERF_L(const long double x) {
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
  return calerf::CALERF_L(x, 0);
}

long double calerf::ERFC_L(const long double x) {
//-------------------------------------------------------------------
...
//  Based on the netlib package by W. J. Cody, January 8, 1985
//-------------------------------------------------------------------
  return calerf::CALERF_L(x, 1);
}

long double calerf::EREX_L(const long double x) {
//-----------------------------------------------------------------
